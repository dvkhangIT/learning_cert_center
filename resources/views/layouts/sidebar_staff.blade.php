  ...
  <ul class="metismenu" id="menu">
    ...
    <li class="{{ setActive(['nhan-vien.chung-chi.in-danh-sach']) }}">
      <a href="{{ route('nhan-vien.chung-chi.in-danh-sach') }}">
        <div class="parent-icon"><i class="fadeIn animated bx bx-printer"></i>
        </div>
