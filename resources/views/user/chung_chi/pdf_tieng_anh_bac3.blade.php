...
<body>
  <div class="certificate-container">
    ...
    <div class="header">
      ...
      <div class="certificate-type">NĂNG LỰC TIẾNG ANH TƯƠNG ĐƯƠNG BẬC 3</div>
      <div class="certificate-subtype">THEO KHUNG NĂNG LỰC 6 BẬC DÙNG CHO VIỆT NAM</div>
    ...
    <div class="content">
      ...
      <div class="description">
        Đã hoàn thành chương trình bồi dưỡng và đạt yêu cầu bài kiểm tra năng lực tiếng Anh tương đương Bậc 3.
      </div>

      <div class="exam-period">
        Từ {{ $chungChi->ngay_bat_dau ? \Carbon\Carbon::parse($chungChi->ngay_bat_dau)->format('d/m/Y') : 'N/A' }} đến {{ $chungChi->ngay_ket_thuc ? \Carbon\Carbon::parse($chungChi->ngay_ket_thuc)->format('d/m/Y') : 'N/A' }} tại Hội đồng kiểm tra Trường Đại học Kỹ thuật - Công nghệ Cần Thơ.
      </div>
      ...
      <div class="results">
        ...
        <div class="result-row">
          ...
          <span>{{ $chungChi->ketQua->diem_viet ?? 'N/A' }}</span>
        </div>
        <div class="result-row">
          <span class="result-label">Điểm Nói:</span>
          <span>{{ $chungChi->ketQua->diem_noi ?? 'N/A' }}</span>
        </div>
      </div>
    </div>
