          ...
          <form
            ...
            <div class="col-md-12">
              ...
              <input type="text" id="ten_cc"
                class="form-control @error('ten_cc')
                  is-invalid
              @enderror"
                name="ten_cc" value="{{ old('ten_cc', $chungChi->ten_cc) }}">
              @error('ten_cc')
            ...
            <div class="col-md-12">
              ...
              @enderror"
                ...
                value="{{ old('ngay_vao_so', $chungChi->ngay_vao_so) }}">
              @error('ngay_vao_so')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
            ...
            <div class="col-md-6">
              ...
              @enderror"
                ...
                value="{{ old('ngay_bat_dau', $chungChi->ngay_bat_dau) }}">
              @error('ngay_bat_dau')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
            ...
            <div class="col-md-6">
              ...
              @enderror"
                ...
                value="{{ old('ngay_ket_thuc', $chungChi->ngay_ket_thuc) }}">
              @error('ngay_ket_thuc')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
