    ...
    <div class="col-xl-8 mx-auto">
      <div class="card">
        <div class="card-body p-4">
          <form action="{{ route('quan-ly.loai-chung-chi.sua-loai-chung-chi', $loaiChungChi->ma_loai_cc) }}"
            ...
            <div class="col-md-12">
              ...
              <input type="text" id="ten_loai_cc"
                class="form-control @error('ten_loai_cc')
                  is-invalid
              @enderror"
                name="ten_loai_cc" value="{{ old('ten_loai_cc', $loaiChungChi->ten_loai_cc) }}">
              @error('ten_loai_cc')
            ...
            <div class="col-md-6">
              <div class="form-check">
                <input class="form-check-input" type="checkbox" name="cau_hinh_diem[]" value="diem_tu_vung"
                  id="diem_tu_vung" {{ in_array('diem_tu_vung', $cauHinhDiem) ? 'checked' : '' }}>
              ...
              <div class="form-check">
                <input class="form-check-input" type="checkbox" name="cau_hinh_diem[]" value="diem_ngu_phap_doc"
                  id="diem_ngu_phap_doc" {{ in_array('diem_ngu_phap_doc', $cauHinhDiem) ? 'checked' : '' }}>
              ...
              <div class="form-check">
                <input class="form-check-input" type="checkbox" name="cau_hinh_diem[]" value="diem_trac_nghiem"
                  id="diem_trac_nghiem" {{ in_array('diem_trac_nghiem', $cauHinhDiem) ? 'checked' : '' }}>
              ...
              <div class="form-check">
                <input class="form-check-input" type="checkbox" name="cau_hinh_diem[]" value="diem_thuc_hanh"
                  id="diem_thuc_hanh" {{ in_array('diem_thuc_hanh', $cauHinhDiem) ? 'checked' : '' }}>
