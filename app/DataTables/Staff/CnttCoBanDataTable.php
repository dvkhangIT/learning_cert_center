...
class CnttCoBanDataTable extends DataTable
{
  ...
  {
    return $this->applyDefaultHtmlConfig($this->builder(), 'cnttcoban-staff-table', true)
  ...
  public function getColumns(): array
  {
    return [
      ...
      Column::make('diem_trac_nghiem')->title('Trắc nghiệm')->orderable(false)->searchable(false),
      Column::make('diem_thuc_hanh')->title('Thực hành')->orderable(false)->searchable(false),
  ...
  protected function filename(): string { return 'CnttCoBanStaff_' . date('YmdHis'); }
}
